use egui::{epaint::RectShape, include_image, Color32, ComboBox, DragValue, Frame, Grid, Image, Layout, Pos2, Rect, Rounding, ScrollArea, Sense, Shape, SidePanel, Stroke, Style, Ui, Vec2};
use egui_modal::Modal;
use ndarray::{Array2, ArrayView1};
use tqdm::tqdm;

use crate::{data_processing::DataSet, msom::{get_vec_std, MSOM}, SOMParams};
use std::{cmp::{max, min}, sync::{Arc, Mutex}};

const TEXT_PREVIEW_CUTOFF: usize = 16;
...
impl Default for VisualizationsUI {
    fn default() -> Self {
        Self { visualizations: vec![], shown_visualization_index: None, current_visualization: Visualization::default(), 
            chosen_dataset_index: None, chosen_map_index: None }
    }
}
        ...
        if let Some(index) = self.shown_visualization_index {
            ...
            .show_inside(ui, |ui| {
                ...
                if lines_to_display.len() == 0 {
                    ...
                    ui.label("Texts in chosen cluster: ");
